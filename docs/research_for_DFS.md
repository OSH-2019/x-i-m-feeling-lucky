...
- [调研报告](#调研报告)
    - [一、项目背景](#一项目背景)
        - [1. 分布式系统的历史](#1-分布式系统的历史)
        - [2. 大学生为什么需要一个分布式文件系统？](#2-大学生为什么需要一个分布式文件系统)
        - [3. 分布式存储系统为什么也需要协调？](#3-分布式存储系统为什么也需要协调)
    - [二、立项依据](#二立项依据)
        - [1. 我们的项目介绍 --- 协调增强的分布式存储系统](#1-我们的项目介绍-----协调增强的分布式存储系统)
        - [2. 与校园文件分享需求的契合](#2-与校园文件分享需求的契合)
    - [三、前瞻与重要性](#三前瞻与重要性)
        - [1. 前瞻](#1-前瞻)
        - [2. 重要](#2-重要)
        - [3. 不足](#3-不足)
    - [四、相关工作](#四相关工作)
        - [P2P](#p2p)
            ...
            - [应用](#应用)
        - [IPFS](#ipfs)
            - [IPFS 和其它分布式系统](#ipfs-和其它分布式系统)
            - [IPFS 具体实现](#ipfs-具体实现)
            - [IPFS 的一些项目](#ipfs-的一些项目)
    - [五、参考文献](#五参考文献)
